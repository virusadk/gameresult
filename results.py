        ...
        for datet in date_mass:
            ...
            with codecs.open('spisok.txt','r' ,'utf-8') as file:
                ...
                for item in file.readlines():
                    ...
                    dateinspisok1 = dateinspisok[:-3]
                    spis.append(dateinspisok1)
                    # print(dateinspisok1)
                    team1surename = line.split('--')[3]
                    spis.append(team1surename)
                    # print(team1surename)
                    team2surename = line.split('--')[4]
                    spis.append(team2surename)
                    spisok.append(spis)
                    # print(spisok)
            message1 = f'Результаты прошлых игр\n'\
                        f'----------------------------------------------------------\n'\
            ...
            for mr in spisok:
                ...
                for game in resultline['reply']['sports'][tr1]['chmps']:
                    ...
                    for igra in evts:
                        ...
                        # print(dateinspisok)        
                        if (date == dataspis) and (t1 == team1) and (t2 == team2):
